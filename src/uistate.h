...
class uistatedata : public JsonSerializer, public JsonDeserializer
{
    public:
        ...
        int adv_inv_left_container_location;
        UID adv_inv_left_container_uid;
        int adv_inv_right_container_location;
        UID adv_inv_right_container_uid;
        ...
        */
        ...
        uistatedata()
        {
            ...
            adv_inv_leftfilter = "";
            adv_inv_rightfilter = "";
            adv_inv_left_container_location = -1;
            adv_inv_left_container_uid = 0;
            adv_inv_right_container_location = -1;
            adv_inv_right_container_uid = 0;
