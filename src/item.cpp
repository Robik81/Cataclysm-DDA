                     ...
                     const time_duration &time_delta )
{
    ...
    if( has_own_flag( "MUSHY" ) ) {
        factor *= 3.0;
    }

    if( has_own_flag( "COLD" ) ) {
...
void item::set_item_specific_energy( const float new_specific_energy )
{
    ...
    } else if( has_own_flag( "COLD" ) ) {
        unset_flag( "COLD" );
    } else if( has_own_flag( "HOT" ) ) {
        unset_flag( "HOT" );
    }
